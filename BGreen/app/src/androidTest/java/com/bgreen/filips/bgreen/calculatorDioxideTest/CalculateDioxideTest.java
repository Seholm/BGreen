...
public class CalculateDioxideTest extends InstrumentationTestCase {
    ...
    private CarbonDioxideCalculator calculator = new CarbonDioxideCalculator();
    ...
    public void testIfGrams() {
        ...
        assertTrue(temp.equals("CO2 sparad: 167.0g"));
    }
    ...
    public void testIfKilograms() {
        ...
        String temp = calculator.calculateSpill(profile.getTotalDistance());
        assertTrue(temp.equals("CO2 sparad: 1.6kg"));
    }
    ...
    public void testIfZero() {
        ...
        String temp = calculator.calculateSpill(profile.getTotalDistance());
        assertTrue(temp.equals("CO2 sparad: 0.0g"));
    }
    ...
    public void testUnderChangeKG(){
        ...
        String temp = calculator.calculateSpill(profile.getTotalDistance());
        assertTrue(temp.equals("CO2 sparad: 999.9g"));
    }
    ...
    public void testOverChangeKG() {
        ...
        String temp = calculator.calculateSpill(profile.getTotalDistance());
        assertTrue(temp.equals("CO2 sparad: 1.0kg"));
    }
